...
public class Search_Symptoms extends AppCompatActivity {
    ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search__symptoms);

       // myDatabase = (MyDatabase) getIntent().getSerializableExtra("Database");
    ...
    public void onStart() {
        ...
        super.onStart();
        SymptomsList.clear();
        Toast.makeText(Search_Symptoms.this,""+SymptomsList.size(),Toast.LENGTH_SHORT).show();
    ...
    public void Start_Searching(){
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            AlertDialog.Builder fever_builder = new AlertDialog.Builder(Search_Symptoms.this);
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final String[] value = {(String) adapter.getItem(position)};
                final String extra[] = new String[5];
                Toast.makeText(Search_Symptoms.this, value[0],Toast.LENGTH_SHORT).show();
                        ...
                        for(DataSnapshot childSnapShot : dataSnapshot.getChildren()){
                            ...
                            if(value1.equals(finalS_id)){
                             ...
                             for(DataSnapshot childSnapShot2 : childSnapShot.child("Clarity").getChildren()){
                                ...
                                Toast.makeText(Search_Symptoms.this, "matched",Toast.LENGTH_SHORT).show();
                             ...
                             arr = fever_clarity.toArray(arr);
                                 fever_builder.setSingleChoiceItems(arr, -1 , new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        extra[0] = arr[which];
                                        Toast.makeText(Search_Symptoms.this, value[0]+extra[0],Toast.LENGTH_SHORT).show();
                                    }
                                });
                                fever_builder.setPositiveButton("ADD", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Toast.makeText(Search_Symptoms.this, value[0],Toast.LENGTH_SHORT).show();
                                        finish();
                                        Intent intent = new Intent(Search_Symptoms.this,EnterSymptoms.class);
